...
<body class="bg-gray-100">
    <style>
        ...
        .notification {
            position: relative;
            /* Adjust for stacking inside the container */
        ...
        #notification-container {
            ...
            /* Ensures the latest notification appears at the bottom */
        }
    </style>
                ...
                <div class="bg-white p-5 rounded-lg shadow mb-5">
                    ...
                    <?php if ($next_patient): ?>
                        ...
                        if (!empty($next_patient['date_of_birth'])) {
                            ...
                            $today = new DateTime();
                            $age = $today->diff($dob);
                            $ageText = $age->y . ' years, ' . $age->m . ' months, ' . $age->d . ' days';
                        } else {
                            $ageText = 'N/A';  // In case date of birth is not available
                        }
                        ?>
                        <div class="flex items-center mb-3">
                            ...
                            <div>
                                ...
                                <p class="text-gray-500">Age: <?= htmlspecialchars($ageText); ?></p>
