    ...
    <div class="containers">
        ...
        if ($result->num_rows > 0) {
            ...
            <div class="profile-card">
                ...
                <a href="../send_message?doctor_id=<?php echo $doctor['doctor_id']; ?>" class="profile-btn">Send Message</a>
                <button class="profile-btn" onclick="window.location.href='../add_review?doctor_id=<?php echo $doctor_id; ?>'">Add Your Review</button>
            </div>
...
<footer>
    <div class="container footer__container">
        <div class="footer__1">
            <a href="inde" class="footer__logo"><h4>HELLO DR.</h4></a>
            <p>
